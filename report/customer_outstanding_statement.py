...
class CustomerOutstandingStatement(models.AbstractModel):
    ...
    def _display_lines_sql_q1(self, partners, date_end):
        return """
            SELECT m.new_name as move_id, m.name as move_name, l.partner_id, l.date, l.name,
            ...
            WHERE l.partner_id IN (%s) AND at.type = 'receivable'
                                ...
                                AND l.date <= '%s'
            GROUP BY l.partner_id, m.new_name, m.name, l.date, l.date_maturity, l.name,
    ...
    def _display_lines_sql_q2(self):
        return """
            SELECT partner_id, currency_id, move_id, move_name, date, date_maturity,
    ...
    def _display_lines_sql_q3(self, company_id):
        return """
            SELECT Q2.partner_id, move_id, move_name, date, date_maturity, Q2.name, ref,
    ...
    def _get_account_display_lines(self, company_id, partner_ids, date_end):
        ...
        SELECT partner_id, currency_id, move_id, move_name, date, date_maturity, debit,
